...
public class JobToJobUpdaterImpl implements JobUpdater {
    ...
    public Job update(Job oldJob, Job newJob) {
        ...
        return oldJob
                .setTitle((isNullOrBlank(newJob.getTitle()) ? oldJob.getTitle() : newJob.getTitle()))
                .setDescription((isNullOrBlank(newJob.getDescription()) ? oldJob.getDescription() : newJob.getDescription()))
                ...
                .setPriceType(newJob.getPriceType() == null ? oldJob.getPriceType() : newJob.getPriceType())
